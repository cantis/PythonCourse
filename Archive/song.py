...
class Song:
    ...
    Attributes:
        ...
        duration (int): The duration of the song in seconds (may be 0)
    """
...
class Album:
    ...
    Attributes:
        ...
        year (int): The year the ablum was released
    ...
    Methods:
        add_song: Used to add a new song to the almum's track list
    """
...
class Artist:
    ...
    Attributes:
        ...
        albums (List[Album]): A list of the albums by this arttist,
    ...
    def add_album(self, album):
        ...
        Args:
            album (Album): Album object to add to the list,
                ...
                (although this is not yet implimented).
        """
        self.albums.append(album)

    def add_song(self, name, year, title):
        """Add a new song to the collectoin of albums

        This method is going to add the song to an album in the collectoin,
        new album will be created if it doesn't already exist.
...
def find_object(field, object_list):
    """ Check 'object_list' to see if an object with a name attribute = field exists
        in the object_list"""
